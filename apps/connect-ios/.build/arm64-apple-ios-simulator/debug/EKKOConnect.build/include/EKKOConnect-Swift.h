...
#ifndef EKKOCONNECT_SWIFT_H
#define EKKOCONNECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EKKOConnect",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Bridged into SwiftUI via <code>@UIApplicationDelegateAdaptor</code>.
SWIFT_CLASS("_TtC11EKKOConnect11AppDelegate")
...
SWIFT_CLASS("_TtC11EKKOConnect15LocationManager")
...
SWIFT_CLASS("_TtC11EKKOConnect11PushManager")
...
@interface PushManager (SWIFT_EXTENSION(EKKOConnect)) <UNUserNotificationCenterDelegate>
